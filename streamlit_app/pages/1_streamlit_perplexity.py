...
def prepare_context_messages(message_history, new_user_input):
    ...
    messages = [
        ...
        },
        {
            "role": "system",
            "content": (
                "Définis les termes juridiques de la question posée et réponds y."
            )
        }
    ]
...
def main():
            ...
            if message.get("metadata"):
                ...
                with col3:
                    cost = (meta['input_tokens'] * 0.000001 + 
                           meta['output_tokens'] * 0.000001 + 0.012)
    ...
    if prompt := st.chat_input("Que recherchez-vous ?"):
